...
def execute_sample(arguments: dict):
    ...
    allele_names = consensus.call_allele_name(
        cons_sequences, cons_percentages, ARGS.fasta_alleles, threshold=50
    )
    ...
    cons_sequences, cons_percentages, cons_midsv_tags = consensus.merge_duplicate_intact_alleles(
        cons_sequences, cons_percentages, cons_midsv_tags
    )
    ...
    RESULT_SAMPLE = consensus.merge_result_sample_intact_alleles(RESULT_SAMPLE)
