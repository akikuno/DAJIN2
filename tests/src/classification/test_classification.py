...
def test_extract_alleles_with_max_score():
    score_of_each_alleles = [
        {"QNAME": "read1", "MIDSV": "=A,=C,=G,=T", "SCORE": 1.0, "ALLELE": "allele1"},
        {"QNAME": "read1", "MIDSV": "=A,=C,=G,=T", "SCORE": 0.5, "ALLELE": "allele2"},
    ]
    result = classifier.extract_alleles_with_max_score(score_of_each_alleles)
    expected_output = [
        {"QNAME": "read1", "MIDSV": "=A,=C,=G,=T", "ALLELE": "allele1"},
    ]
    assert result == expected_output
...
def test_extract_alleles_with_max_score_multiple_reads():
    score_of_each_alleles = [
        {"QNAME": "read1", "MIDSV": "=A,=C,=G,=T", "SCORE": 1.0, "ALLELE": "allele1"},
        {"QNAME": "read1", "MIDSV": "=A,=C,=G,=T", "SCORE": 0.5, "ALLELE": "allele2"},
        {"QNAME": "read2", "MIDSV": "=A,=C,=G,=T", "SCORE": 0.5, "ALLELE": "allele1"},
        {"QNAME": "read2", "MIDSV": "=A,=C,=G,=T", "SCORE": 1.0, "ALLELE": "allele2"},
    ]
    result = classifier.extract_alleles_with_max_score(score_of_each_alleles)
    expected_output = [
        {"QNAME": "read1", "MIDSV": "=A,=C,=G,=T", "ALLELE": "allele1"},
        {"QNAME": "read2", "MIDSV": "=A,=C,=G,=T", "ALLELE": "allele2"},
    ]
    assert result == expected_output
