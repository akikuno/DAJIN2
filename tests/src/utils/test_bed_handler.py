...
class TestParseBedFile:
    ...
    def test_parse_bed_file_minimal(self):
        """Test BED file with minimal 3 columns."""
        bed_content = "chr2\t1000\t2000"
...
chr2\t300\t400"""
    ...
    def test_parse_bed_file_invalid_coordinates(self):
        ...
        bed_content = "chr1\t200\t100"  # end < start
    ...
    def test_parse_bed_file_invalid_strand(self):
        ...
        bed_content = "chr1\t100\t200\tfeature\t0\tx"  # Invalid strand 'x'
    ...
    def test_parse_bed_file_empty_strand(self):
        ...
        bed_content = "chr1\t100\t200\t123456\t0\t"  # Empty strand
